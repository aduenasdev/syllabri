...
const COPY = {
  es: {
    eyebrow: "Soluciones",
    title: "Formatos concretos de producto",
    body: "Vigilancia tecnológica, decision support, copilotos operativos e IA soberana. Página en construcción.",
  },
  en: {
    eyebrow: "Solutions",
    title: "Concrete product formats",
    body: "Technology watch, decision support, operational copilots, and sovereign AI. Page under construction.",
  },
} as const;
